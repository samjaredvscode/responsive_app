...
/// mixture of any widgets, but there is special handling for [NavigationDrawerDestinationCustom]s.
...
///
/// {@tool dartpad}
/// This example shows a [NavigationDrawerCustom] used within a [Scaffold]
/// widget. The [NavigationDrawerCustom] has headline widget, divider widget and three
/// [NavigationDrawerDestinationCustom] widgets. The initial [selectedIndex] is 0.
...
class NavigationDrawerCustom extends StatelessWidget {
  ...
  /// The background color of the [Material] that holds the [NavigationDrawerCustom]'s
  /// contents.
  ///
  ...
  ///  The surface tint of the [Material] that holds the [NavigationDrawerCustom]'s
  /// contents.
  ///
  ...
  /// The elevation of the [NavigationDrawerCustom] itself.
  ///
  ...
  ///
  /// The list contains [NavigationDrawerDestinationCustom] widgets and/or customized
  /// widgets like headlines and dividers.
  final List<Widget> children;

  /// The index into destinations for the current selected
  /// [NavigationDrawerDestinationCustom] or null if no destination is selected.
  ///
  /// A valid [selectedIndex] satisfies 0 <= [selectedIndex] < number of [NavigationDrawerDestinationCustom].
  /// For an invalid [selectedIndex] like `-1`, all desitinations will appear unselected.
  final int? selectedIndex;

  /// Called when one of the [NavigationDrawerDestinationCustom] children is selected.
  ///
  /// This callback usually updates the int passed to [selectedIndex].
  ///
  /// Upon updating [selectedIndex], the [NavigationDrawerCustom] will be rebuilt.
  final ValueChanged<int>? onDestinationSelected;

  @override
  Widget build(BuildContext context) {
    final int totalNumberOfDestinations =
        children.whereType<NavigationDrawerDestinationCustom>().toList().length;
    ...
    for (int i = 0; i < children.length; i++) {
      if (children[i] is! NavigationDrawerDestinationCustom) {
...
/// A Material Design [NavigationDrawerCustom] destination.
///
/// Displays an icon with a label, for use in [NavigationDrawerCustom.children].
class NavigationDrawerDestinationCustom extends StatelessWidget {
  /// Creates a navigation drawer destination.
  const NavigationDrawerDestinationCustom({
    super.key,
    this.backgroundColor,
    required this.icon,
    this.selectedIcon,
...
class _NavigationDestinationBuilder extends StatelessWidget {
  /// Builds a destination (icon + label) to use in a Material 3 [NavigationDrawerCustom].
  ...
  /// Builds the icon for a destination in a [NavigationDrawerCustom].
  ///
  ...
  /// Builds the label for a destination in a [NavigationDrawerCustom].
  ///
  /// To animate between unselected and selected, build the icon based on
  ...
  /// increasing or completed, and it is considered unselected as soon as the
  /// animation is decreasing or dismissed.
  final WidgetBuilder buildTrailing;

  @override
  Widget build(BuildContext context) {
    final info = _NavigationDrawerDestinationInfo.of(context);
    final navigationDrawerTheme = NavigationDrawerTheme.of(context);
    final defaults = _NavigationDrawerDefaultsM3(context);
        ...
        child: SizedBox(
          ...
          child: InkWell(
            ...
            child: Stack(
              ...
              children: <Widget>[
                NavigationIndicator(
                  animation: _NavigationDrawerDestinationInfo.of(context)
                      .selectedAnimation,
...
/// [NavigationDrawerCustom] by default).
///
...
/// Inherited widget for passing data from the [NavigationDrawerCustom] to the
/// [NavigationDrawerCustom.destinations] children widgets.
///
...
class _NavigationDrawerDestinationInfo extends InheritedWidget {
  ...
  ///
  /// This is computed by calling [NavigationDrawerCustom.onDestinationSelected]
